  ...
  return (
    <header className="border-b border-rule/70 bg-clean/90 backdrop-blur">
      <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-6 px-6 py-4 lg:px-12">
        ...
        <Link
          href="/dropoff"
          className="shrink-0 whitespace-nowrap rounded-lg bg-sage px-4 py-2 text-xs font-semibold text-white transition-colors hover:bg-forest-dark sm:px-5 sm:py-2.5 sm:text-sm"
        >
          Send a Padala
        </Link>
      </div>
